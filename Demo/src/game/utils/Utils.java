...
public class Utils {
	...
	// Fonction pour obtenir le point à partir d'un premier point, d'un angle et
	// d'une distance
	...
	// Fonction pour convertir une "direction" d'une entité en un angle en radians
	// grâce à la map créée plus haut
