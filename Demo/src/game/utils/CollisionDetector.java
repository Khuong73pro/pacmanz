...
public class CollisionDetector {
	...
	// Détection de collision entre des entités de type collisionCheck et une entité
	// obj ; on renvoie l'entité du type testé en cas de collision
	// Les entités de type collisionCheck ont une hitbox rectangulaire, et on
	// considère ici que la hitbox de l'entité obj est un point (pour la collision
	// entre Pacman et les fantôme, ça permet d'avoir une marge et faire en sorte
	// que le jeu ne soit pas trop punitif)
	...
	// Même chose que la méthode précédente, mais toutes les hitboxes sont
