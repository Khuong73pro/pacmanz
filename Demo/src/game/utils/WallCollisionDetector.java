...
public class WallCollisionDetector {
	// Fonction pour s'avoir s'il y a un mur à la position d'une entité + un certain
	// delta (ce delta permet de détecter le mur avant de rentrer dedans)
	...
	// Même chose que la méthode précédente, mais on peut ignorer ici les collisions
	// avec les murs de la maison des fantômes
