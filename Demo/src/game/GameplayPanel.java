...
public class GameplayPanel extends JPanel implements Runnable {
	...
	// "rendu du jeu" ; on prépare ce qui va être affiché en dessinant sur une
	// "image" : un fond et les entités du jeu au dessus
	public void render() {
		if (g != null) {
	...
	public void run() {
		...
		// Pour faire en sorte que le jeu tourne à 60FPS (tutoriel consulté :
		// https://www.youtube.com/watch?v=LhUN3EKZiio)
