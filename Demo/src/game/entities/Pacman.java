...
public class Pacman extends MovingEntity implements Sujet {
	...
	public void input(KeyHandler k) {
		...
		if (!onTheGrid())
			return; // Pacman doit être sur une "case" de la zone de jeu
		if (!onGameplayWindow())
			return; // Pacman doit être dans la zone de jeu
	...
	@Override
	public void update() {
		// On teste à chaque fois si Pacman est en contact avec une PacGum, une
		// SuperPacGum, ou un fantôme, et les observers sont notifiés en conséquence
		...
		// S'il n'y a pas de mur à la prochaine position potentielle de Pacman, on met à
		// jour sa position
