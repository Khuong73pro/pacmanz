...
public class HouseMode extends GhostState {
	...
	// Dans cet état, la position ciblée est la case juste au dessus de la maison
	// des fantômes
	@Override
	...
	// Même chose que la méthode de la classe abstraite, mais on ignore ici les
	// collisions avec les murs de la maison des fantômes
	@Override
