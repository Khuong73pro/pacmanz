...
public class InkyStrategy implements IGhostStrategy {
	...
	// Inky se base sur la position de Blinky pour cibler Pacman : on prend un
	// vecteur entre la position de Blinky et une case devant Pacman, et additionne
	// ce vecteur à la position une case devant Pacman pour obtenir la cible d'Inky
	@Override
	public int[] getChaseTargetPosition() {
		...
		double distanceOtherGhost = Utils.getDistance(pacmanFacingPosition[0], pacmanFacingPosition[1],
		...
		int[] blinkyVectorPosition = Utils.getPointDistanceDirection(pacmanFacingPosition[0], pacmanFacingPosition[1],
